...
public class Const {
    ...
    final static List<String> serverReal = Arrays.asList("eth", "test");
...
//    public static final int DRAW_MODE_TAKE_CLEAR = 4103;
    ...
    // 청구서 발송 docDivCd
    public static final String DOC_DIV_CD = "TAXBIL";
    ...
    ////////// QA
    //public static final String API_BASE_URL = "https://api.apps.lis-prj.seegenemedical.com/mb/";
    ////////// DEV
