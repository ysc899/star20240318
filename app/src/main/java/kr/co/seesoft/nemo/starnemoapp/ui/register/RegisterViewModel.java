...
public class RegisterViewModel extends AndroidViewModel {
    ...
    public RegisterViewModel(Application application) {
        ...
        //AndroidUtil.log("===>deptCode : " + deptCode);
            ...
            public void handleMessage(@NonNull Message msg) {
                ...
                switch (msg.what){
                    case 200:
                        ...
                        AndroidUtil.log("pictureVO : " + pictureVO);
...
//                            sendCount.setValue(Integer.parseInt( result.getImgCnt() ));
    ...
    public void setHospital(NemoScheduleListRO hospitalInfo) {
        ...
        api.getCustomerInfo(param, detailApiHandler);

        AndroidUtil.log("NemoCustomerInfoPO : " + param);
    ...
    public void setRegisterDate(Date registerDate) {
        //AndroidUtil.log("setRegisterDate : " + registerDate);
    ...
    public String getRegisterDateYmd(){
        //AndroidUtil.log("getRegisterDateYmd : " + registerDate);
...
//            }).collect(Collectors.toList());
            ...
            AndroidUtil.log("partitionSendList : " + partitionSendList);
...
//                }
    ...
    public void partitionDataSendSync(){
        ...
        //AndroidUtil.log("checkPartition : " + checkPartition);
        ...
        if(checkPartition.size() > 0) {
            ...
            executorService.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    //AndroidUtil.log("sendList : " + sendList);
                    ...
                    for (PictureVO t : sendList) {
                        ...
                        try {
                            ...
                            AndroidUtil.log("sendList.indexOf(t) : " + sendList.indexOf(t));
                            AndroidUtil.log("sendList.size() : " + sendList.size());
                            AndroidUtil.log("isLast : " + isLast);
                            ...
                            if(StringUtils.isNotEmpty(fName)){
                                ...
                                AndroidUtil.log("NemoImageAddRO : " + ro);
